...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    {
        // Un-Subscribe to set active weapon event
        player.setActiveWeaponEvent.OnSetActiveWeapon -= SetActiveWeaponEvent_OnSetActiveWeapon;

        // Un-Subscribe to weapon fired event
        player.weaponFiredEvent.OnWeaponFired -= WeaponFiredEvent_OnWeaponFired;

        // Un-Subscribe to reload weapon event
        player.reloadWeaponEvent.OnReloadWeapon -= ReloadWeaponEvent_OnWeaponReload;

        // Un-Subscribe to weapon reloaded event
        player.weaponReloadedEvent.OnWeaponReloaded -= WeaponReloadedEvent_OnWeaponReloaded;
    }
    ...
    {
        // Loop through icon gameObject and destroy
    ...
    /// <summary>
    /// Stop coroutine updating ewapon reload progress bar
    /// </summary>
    ...
    /// <summary>
    /// Stop the blinking relod text coroutine
    /// </summary>
