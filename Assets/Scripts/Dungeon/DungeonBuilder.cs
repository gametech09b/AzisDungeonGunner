...
public class DungeonBuilder : SingletonMonobehaviour<DungeonBuilder>
{
    ...
    protected override void Awake()
    {
        ...
        //Set dimemd material to fully visible
    ...
    /// <summary>
    /// Attempt to randomly build the dungeon for the specified room node graph. return true if a
    ...
    private bool AttemptToBuildRandomDungeon(RoomNodeGraphSO roomNodeGraph)
    {
        ...
        //if all the room node have been processed and there hasn't been a room overlap the return true
    ...
    private bool ProcessRoomsInOpenRoomNodeQueue(RoomNodeGraphSO roomNodeGraph, Queue<RoomNodeSO> openRoomNodeQueue, bool noRoomOverlaps)
    {
        ...
        while (openRoomNodeQueue.Count > 0 && noRoomOverlaps == true)
        {
            ...
            //else if the room type isn't entrance
            else
            {
    ...
    private bool CanPlaceRoomWithNoOverlaps(RoomNodeSO roomNode, Room parentRoom)
    {
        ...
        // Do while room overlaps, try to place against all available doorway of the parent
        // until the room is successfully placed without overlaps
        while (roomOverlaps)
        {
            // Select random unconnectted available doorway for Parent
            ...
            {
                // if room doesn't overlapthen set to falseto exit while loop
                roomOverlaps = false;
    ...
    private bool PlaceTheRoom(Room parentRoom, Doorway doorwayParent, Room room)
    {
        ...
        // Calculate adjustment position offset based on room doorway position that we are trying to connect (e.g. if this doorway west then we need to add (1, 0) to the east parent doorway)
        ...
        // Calculate room loveer bounds and upper bounds based on positioning to align with parent doorway
    ...
    /// <summary>
    /// Check for rooms that overlap the upper and lower bounds parameters, and if there are overlapping room then return room else return null
    /// </summary>
    ...
    /// <summary>
    /// Check if 2 rooms overlap each other, return true if they overlap or false if they didn't
    /// </summary>
