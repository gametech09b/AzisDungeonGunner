...
public class DungeonLevelSO : ScriptableObject
{
    ...
    #endregion
    #region Tooltip
    [Tooltip("Populate the list with the room templates that you want to be part of the level. You need to ensure that room template are included for all room node types that are specified in the Room Node Graphs for the levels.")]
    #endregion
    ...
    #endregion
    #region Tooltip
    [Tooltip("Populate this list with te room node graphs which should be randomly selected from for the level.")]
    #endregion
